...
# perf-test-website skill's lg-monitoring.md.
#
# Usage:
#   tools/run-with-monitor.sh tests/wN-<name>/smoke.js
#   tools/run-with-monitor.sh tests/wN-<name>/stress.js
#   INTERVAL=2 tools/run-with-monitor.sh tests/wN-<name>/spike.js   # finer sampling
#
# Writes:
