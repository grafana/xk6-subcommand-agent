...
See the `perf-test-website` skill references:
...
# 2. Regenerate raw k6
npx har-to-k6 recordings/har/wN.har -o tests/wN-<name>/from-har.js

# 3. By hand: bring new asset paths / request sequences into
#    tests/wN-<name>/protocol.js and tests/wN-<name>/browser.js.
